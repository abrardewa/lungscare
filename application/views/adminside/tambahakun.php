                    ...
                    <div class="row">
                        ...
                        <div class="col-xl">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-body">
                                        <form action="<?= base_url('Welcome/tambahakun'); ?>" method="post">
                                            <div class="form-group">
                                                <label for="nama">Nama</label>
                                                <input style="width: 800px; height: 40px;" type="text" class="form-control" id="nama" name="nama" placeholder="Cth: Abrar" value="<?= set_value('nama'); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="username">Username</label>
                                                <input style="width: 800px; height: 40px;" type="text" class="form-control" id="username" name="username" placeholder="Cth: abrar123" value="<?= set_value('username'); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="pw">Password</label>
                                                <input style="width: 800px; height: 40px;" type="text" class="form-control" id="password" name="password" placeholder="Cth: *******">
                                            </div>
                                            <div class="form-group">
                                                <label for="status">Status (aktif/tidak aktif)</label>
                                                <input style="width: 800px; height: 40px;" type="text" class="form-control" id="status" name="status" placeholder="Cth: Aktif" value="<?= set_value('status'); ?>">
                                            </div>
                                            <div class="form-group">
                                                <br>
