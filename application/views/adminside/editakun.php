            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url() ?>welcome/pertanyaanfaq">Pertanyaan FAQ</a>
                        <a class="collapse-item" href="<?= base_url() ?>welcome/penyakit">Penyakit</a>
                        <a class="collapse-item active" href="<?= base_url() ?>welcome/akun">Akun</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-body">
                                        <form style=" font-size:18px; color:black" action="<?= base_url('Welcome/updateakun'); ?>" method="post" enctype='multipart/form-data'>
                                            <input type="hidden" name="id" value="<?= $akun['id']; ?>">
                                            <div class="form-group">
                                                <label for="nama">Nama</label>
                                                <input style="width: 800px; height: 40px;" type="text" class="form-control" id="nama" name="nama" placeholder="Cth: Abrar" value="<?= $akun['nama']; ?>" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="username">Username</label>
                                                <input style="width: 800px; height: 40px;" type="text" class="form-control" id="username" name="username" placeholder="Cth: abrar123" value="<?= $akun['username']; ?>" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="password">Password</label>
                                                <input style="width: 800px; height: 40px;" type="password" class="form-control" id="password" name="password" placeholder="Cth: *******" value="<?= $akun['password']; ?>" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="status">Status (aktif/tidak aktif)</label>
                                                <input style="width: 800px; height: 40px;" type="text" class="form-control" id="status" name="status" placeholder="Cth: Aktif" value="<?php if ($akun['is_active'] == 1) {
                                                                                                                                                                                            echo "Aktif";
                                                                                                                                                                                        } else {
                                                                                                                                                                                            echo "Tidak Aktif";
                                                                                                                                                                                        } ?>" required>
                                            ...
                                            <div class="form-group">
                                                <br>
                                                <button type="submit" class="btn btn-info col-sm-2 float-right" style="margin-right: 0px;">Update</button>
                                            </div>
