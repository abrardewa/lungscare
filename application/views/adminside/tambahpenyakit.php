                    ...
                    <div class="row">
                        ...
                        <div class="col-xl">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-body">
                                        <form style=" font-size:18px; color:black" action="<?= base_url('Welcome/tambahpenyakit'); ?>" method="post">
                                            <div class="form-group">
                                                <label for="penyakit">Nama Penyakit</label>
                                                <input type="text" class="form-control" id="penyakit" name="penyakit" placeholder="Cth: Pneumonia" value="<?= set_value('penyakit'); ?>">
                                            </div>
                                            <div class="form-group">
