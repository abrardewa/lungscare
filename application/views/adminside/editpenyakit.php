            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="<?= base_url() ?>welcome/penyakit">Penyakit</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-body">
                                        <form style=" font-size:18px; color:black" action="<?= base_url('Welcome/updatepenyakit'); ?>" method="post">
                                            <input type="hidden" name="id" value="<?= $penyakit['id']; ?>">
                                            <div class="form-group">
                                                <label for="penyakit">Nama Penyakit</label>
                                                <input style="width: 800px; height: 40px;" type="text" class="form-control" id="penyakit" name="penyakit" placeholder="Cth: Pneumonia" value="<?= $penyakit['penyakit']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="bobot">Gejala Penyakit</label>
                                                <input style="width: 800px; height: 40px;" type="text" class="form-control" id="gejala" name="gejala" placeholder="Cth: 127" value="<?= $penyakit['gejala']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <br>
