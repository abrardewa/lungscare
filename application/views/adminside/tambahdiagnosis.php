            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="active collapse-item" href="<?= base_url() ?>welcome/pertanyaandiagnosis">Pertanyaan Diagnosis</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-body">
                                        <form style=" font-size:18px; color:black" action="<?= base_url('Welcome/tambahdiagnosis'); ?>" method="post">
                                            <div class="form-group">
                                                <label for="pertanyaan">Input Pertanyaan Untuk Pemeriksaan</label>
                                                <input s type="text" class="form-control" id="pertanyaan" name="pertanyaan" placeholder="Cth: Apakah anda sesak napas?" value="<?= set_value('pertanyaan'); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="gejala">Input Nama Gejala</label>
                                                <input type="text" class="form-control" id="gejala" name="gejala" placeholder="Cth: sesak napas" value="<?= set_value('gejala'); ?>">
                                            </div>
                                            <div class="form-group">
                                                <br>
