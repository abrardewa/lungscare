            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="active collapse-item" href="#">Pertanyaan Diagnosis</a>
                        ...
                        <div class="col-xl">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Edit Diagnosis</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card shadow mb-4">
                                    <div class="card-body">
                                        <form style=" font-size:18px; color:black" action="<?= base_url('Welcome/updatepertanyaandiagnosis'); ?>" method="post">
                                            <input type="hidden" name="id" value="<?= $pertanyaandiagnosis['id']; ?>">
                                            <div class="form-group">
                                                <label for="pertanyaan">Input Pertanyaan Untuk Pemeriksaan</label>
                                                <input style="width: 800px; height: 40px;" type="text" class="form-control" id="pertanyaan" name="pertanyaan" placeholder="Cth: Apakah anda sesak napas?" value="<?= $pertanyaandiagnosis['pertanyaan']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="gejala">Input Nama Gejala</label>
                                                <input style="width: 800px; height: 40px;" type="text" class="form-control" id="gejala" name="gejala" placeholder="Cth: Apakah anda sesak napas?" value="<?= $pertanyaandiagnosis['gejala']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <br>
